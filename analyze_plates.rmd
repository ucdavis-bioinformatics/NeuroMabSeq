...
# Set up index for yield category for REPORTED sequences
...
tb = ndup[ndup$SampleType == 'oligoclonal' & ndup$YieldCategory == 'LC=1 and HC=1',c("sample_name","trimmer_id", "Category", 'LCs.Reported', 'HCs.Reported', 'LC.K.Called',"HC.H.Called")]
